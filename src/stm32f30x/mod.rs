...
pub const FLASH_BASE:           usize = 0x08000000;                     //FLASH base address in the alias region
pub const CCMDATARAM_BASE:      usize = 0x10000000;
pub const SRAM_BASE:            usize = 0x20000000;                     //SRAM base address in the alias region
pub const PERIPH_BASE:          usize = 0x40000000;                     //Peripheral base address in the alias region
pub const FMC_R_BASE:           usize = 0xA0000000;                     //FMC registers base address
pub const CCMDATARAM_BB_BASE:   usize = 0x12000000;
pub const SRAM_BB_BASE:         usize = 0x22000000;                     //SRAM base address in the bit-band region
